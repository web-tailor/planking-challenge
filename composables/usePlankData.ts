...
const RAW: Record<string, { joinDay?: number; times: string[] }> = {
  Stijn:  { times: ['3:34', '0:00', '4:15', '5:02', '3:30', '6:00', '6:02', '6:06', '6:12', '6:20', '6:31', '6:50', '7:00', '7:10', '7:15', '7:18', '7:30', '8:00', '8:05', '8:15', '9:00', '9:02'] },
  André:  { times: ['4:00', '4:02', '2:45', '4:30', '4:49', '4:20', '5:10', '5:30', '6:00', '6:20', '6:40', '6:41', '7:30', '7:35', '8:00', '8:30', '8:35', '8:42', '8:45', '8:46', '8:47', '9:00'] },
  Pierre: { times: ['3:00', '3:30', '3:40', '3:50', '4:00', '4:15', '4:23', '4:30', '4:45', '4:50', '5:25', '5:30', '4:00', '6:01', '5:00', '4:30', '4:50', '3:30', '3:30', '4:28', '5:00', '4:00'] },
  Paul:   { times: ['1:49', '3:30', '3:40', '4:00', '5:02', '5:30', '6:03', '6:10', '6:15', '6:20', '6:30', '6:46', '8:00', '8:05', '8:10', '8:20', '8:32', '8:40', '9:00', '10:00', '10:05', '10:10'] },
}
