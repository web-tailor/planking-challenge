...
const RAW: Record<string, { joinDay?: number; times: string[] }> = {
  Stijn:  { times: ['3:34', '0:00', '4:15', '5:02', '3:30', '6:00', '6:02', '6:06', '6:12', '6:20', '6:31', '6:50', '07:00', '7:10', '7:15'] },
  André:  { times: ['4:00', '4:02', '2:45', '4:30', '4:49', '4:20', '5:10', '5:30', '6:00', '6:20', '6:40', '6:41', '7:30', '7:35', '8:00'] },
  Pierre: { times: ['3:00', '3:30', '3:40', '3:50', '4:00', '4:15', '4:23', '4:30', '4:45', '4:50', '5:25', '5:30', '4:00', '6:01', '5:00'] },
  Paul:   { times: ['1:49', '3:30', '3:40', '4:00', '5:02', '5:30', '6:03', '6:10', '6:15', '6:20', '6:30', '6:46', '8:00', '8:05', '8:10'] },
  Brian:  { times: ['3:05', '3:15', '3:26', '0:00', '4:06', '0:00', '2:11', '0:00', '5:10', '0:00', '5:16', '4:06', '6:10', '0:00', '0:00'] },
}
