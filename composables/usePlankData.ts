...
const RAW: Record<string, { joinDay?: number; times: string[] }> = {
  Stijn:  { times: ['3:34', '0:00', '4:15', '5:02', '3:30', '6:00', '6:02', '6:06', '6:12', '6:20'] },
  André:  { times: ['4:00', '4:02', '2:45', '4:30', '4:49', '4:20', '5:10', '5:30', '6:00', '6:20'] },
  Pierre: { times: ['3:00', '3:30', '3:40', '3:50', '4:00', '4:15', '4:23', '4:30', '4:45', '4:50'] },
  Paul:   { times: ['1:49', '3:30', '3:40', '4:00', '5:02', '5:30', '6:03', '6:10', '6:15', '6:20'] },
  Brian:  { times: ['3:05', '3:15', '3:26', '0:00', '4:06', '0:00', '2:11', '0:00', '5:10', '0:00'] },
  Zach:  { joinDay: 8, times: ['1:57', '0:00', '0:00'] },
}
